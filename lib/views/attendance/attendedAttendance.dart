...
class AttendedPage extends StatelessWidget {
  final List<Absent> attendedList;

  const AttendedPage({Key key, this.attendedList}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: renderapplicationBar("PRESENT DAYS"),
      body: Column(
        children: [
          StudentInfo(
            hasBackIcon: true,
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return attendedInfo(
                            context, index, attendedList[index]);
                      },
                    ),
                  ),
  ...
  Widget attendedInfo(BuildContext context, int index, Absent attended) {
    return Container(
